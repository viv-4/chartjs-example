$(document).ready(function(){
  ...
  // Pie Chart
  const pieChartCanvas = $('#pieChartCanvas')
  ...
  // Doughnut Chart
  const doughnutChartCanvas = $('#doughnutChartCanvas')
  ...
  // Polar Chart
  const polarAreaChartCanvas = $('#polarAreaChartCanvas')
  ...
  // Radar Chart
  const radarChartCanvas = $('#radarChartCanvas')
  ...
  // Line Chart
  const lineChartCanvas = $('#lineChartCanvas')
